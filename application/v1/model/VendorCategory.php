...
class VendorCategory extends Model
{
    ...
    public function getStoreClassList($condition = array(), $pagesize = '', $limit = '', $order = 'sc_sort asc,sc_id asc') {
        return $this->table('vendor_category')->where($condition)->order($order)->page($pagesize)->limit($limit)->select();
    }
    ...
    public function add($param){
        ...
        if (is_array($param)){
            ...
            $result = Db::insert('vendor_category',$tmp);
            return $result;
        }else {
            return false;
        }
    ...
    public function update($param){
        ...
        if (is_array($param)){
            ...
            $result = Db::update('vendor_category',$tmp,$where);
            return $result;
        }else {
            return false;
        }
    ...
    public function del($id){
        if (intval($id) > 0){
            ...
            $result = Db::delete('vendor_category',$where);
            return $result;
        }else {
            return false;
        }
