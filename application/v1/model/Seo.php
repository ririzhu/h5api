...
class Seo extends Model
{
    ...
    private function getSeo($type){
        if (!$list = $this->H('bbc_seo')){
            $list = $this->H('bbc_seo',true);
        }
        return $list[$type];
    }
    ...
    public function show(){
        ...
        return $this->seo;
        //Template::output('html_title',$this->seo['title'] ? $this->seo['title'] : C('site_name'));
        //Template::output('seo_keywords',$this->seo['keywords'] ? $this->seo['keywords'] : C('site_name'));
        //Template::output('seo_description',$this->seo['description'] ? $this->seo['description'] : C('site_name'));
    }
