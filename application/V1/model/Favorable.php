...
class Favorable extends Model
{
     ...
     *
     */
    public function getMansongNewStartTime($vid) {
        if(empty($vid)) {
            return null;
        }
        $condition = array();
     ...
     *
     */
    public function getMansongInfoByID($mansong_id, $vid = 0) {
     ...
     *
     */
    public function getMansongRuleByStoreID($vid, $order_price) {
        $mansong_info = $this->getMansongInfoByStoreID($vid);
