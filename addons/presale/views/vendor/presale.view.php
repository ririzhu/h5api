...
<div class="tabmenu">
    <ul class="tab pngFix">
        <li class="normal"><a href="index.php?app=presale&mod=index&sld_addons=presale">预售列表</a></li></ul>
</div>
          ...
          <dd class="wq_upfile">
              <div class="bbc_ms-upload-thumb voucher-pic" style="width: 215px;">
                  <p style="width: 215px;"><i class="fa-image iconfontfa add_iconcolor"></i>
                      <img bbctype="img_tuan_image" width="100%" <?php if(!$output['presale_info']['pre_pic']){?>style="display:none;"<?php }?> src="<?php echo gthumb($output['presale_info']['pre_pic'], 'max');?>"/></p>
              </div>
              <input bbctype="tuan_image" name="tuan_image" type="hidden" value="<?php echo $output['presale_info']['pre_pic'];?>" id="tuan_image">
...
<!--      <dl>
          ...
          <dd>
              ...
              <input type="radio" name="sld_status" <?php /*if($output['presale_info']['sld_status']==1){*/?>checked="checked"<?php /*}*/?> value="1" id="sld_status1" class="vm mr5" />
              <label for="sld_status0">禁用</label>
              <input type="radio" name="sld_status" <?php /*if(!$output['presale_info']['sld_status']){*/?>checked="checked"<?php /*}*/?> value="0" id="sld_status0" class="vm mr5" />
              <span></span>
              <p class="hint">建议3人以上</p>
          </dd>
      </dl>-->
      <dl>
          <dt><i class="required">*</i><?php echo '预售类别:';?></dt>
          <dd>
              <!--      分类是二级的代码 留着点
              <select id="class_idp" class="w80">
                  ...
                  <?php /*if(is_array($output['class_list'])) { */?>
                      <?php /*foreach($output['class_list'] as $tuan_class) { */?>
                          <option <?php /*echo $output['presale_info']&&$output['presale_info']['pid']==$tuan_class['id']?'selected':'';*/?> value="<?php /*echo $tuan_class['id'];*/?>"><?php /*echo $tuan_class['sld_typename'];*/?></option>
                      <?php /*} */?>
                  <?php /*} */?>
              </select>
              <select id="class_id" name="class_id" class="w80">
                  <?php /*if(is_array($output['class_list2'])) { */?>
                      <?php /*foreach($output['class_list2'] as $tuan_class) { */?>
                          <option <?php /*echo $output['presale_info']['sld_type']==$tuan_class['id']?'selected':'';*/?> value="<?php /*echo $tuan_class['id'];*/?>"><?php /*echo $tuan_class['sld_typename'];*/?></option>
                      <?php /*} */?>
                  <?php /*} */?>
              </select>-->
              <select id="class_id" name="class_id" class="w80" disabled="true">
                  <?php if(is_array($output['class_list'])) { ?>
                  <?php foreach($output['class_list'] as $tuan_class) { ?>
                  <option <?php echo $output['presale_info']['sld_type']==$tuan_class['id']?'selected':'';?> value="<?php echo $tuan_class['id'];?>"><?php echo $tuan_class['class_name'];?></option>
                  <?php } ?>
                  <?php } ?>
              </select>
              <span></span>
<!--              <p class="hint">--><?php //echo $lang['tuan_class_tip'];?><!--</p>-->
      ...
      <dl>
          ...
          <dd>
              <input id="start_time" name="start_time" value="<?php echo $output['presale_info']['pre_start_time'];?>" disabled="true" type="text" class="text w130" /><em class="add-on"><i class="iconfontfa fa-calendar"></i></em>  至
              <input id="end_time" name="end_time" value="<?php echo $output['presale_info']['pre_end_time'];?>" disabled="true" type="text" class="text w130"/><em class="add-on"><i class="iconfontfa fa-calendar"></i></em>
      ...
      <dl>
          ...
          <dd>
              <input class=" text w60" name="sld_max_buy" type="text" id="sld_max_buy" value="<?php echo $output['presale_info']['pre_max_buy']!=''?$output['presale_info']['pre_max_buy']:1;?>" disabled="true" maxlength="30"  /> 件
              <span></span>
              <p class="hint">为0则不限购买数量</p>
          </dd>
      </dl>
<!--      <dl>-->
<!--          <dt><i class="required">*</i>--><?php //echo '退还定金:'; ?><!--</dt>-->
<!--          <dd>-->
<!--              否:<input type="radio" name="is_tui" value="0" --><?php //echo $output['presale_info']['is_tui']==0?'checked':''; ?><!-- disabled="true">-->
<!--              是: <input type="radio" name="is_tui" value="1" --><?php //echo $output['presale_info']['is_tui']==1?'checked':''; ?><!-- disabled="true">-->
<!--              <p class="hint">是否退换定金(针对库存不足或未达到第一阶梯情况下)</p>-->
<!--          </dd>-->
<!--      </dl>-->
      <dl>
          <dt><i class="required">*</i><?php echo '支付时间:';?></dt>
          <dd>
              <input class=" text w60" name="sld_success_time" type="text" id="sld_success_time" value="<?php echo $output['presale_info']['pre_limit_time']?$output['presale_info']['pre_limit_time']:24;?>" disabled="true" maxlength="30"  /> 小时
              <span></span>
              <p class="hint">限制时间内支付尾款成功才能发货</p>
          </dd>
      </dl>
      <!--<dl>
          ...
          <dd style="position: relative;">
              ...
              <input id="tuan_goods_id" name="tuan_goods_id" type="hidden" value="<?php /*echo $output['presale_info']['sld_goods_id'];*/?>"/>
              <span></span>
                      ...
                      <?php foreach ($output['presale_info']['goods_list'] as $g_info) { ?>
                          <div class="p_list clearfix">
                              <ul>
                                  ...
                                  <li>
                                      <p>* 预售库存（件）</p>
                                      <input type="text" value="<?php echo $g_info['goods_stock']; ?>" name="sld_stock[<?php echo $g_info['gid']; ?>]" disabled="true">
                                  </li>
                                  <li>
                                      <p>* 预售定金（元）</p>
                                      <input type="text" value="<?php echo $g_info['pre_deposit_price']; ?>"
                                             name="sld_pin_price[<?php echo $g_info['gid']; ?>]" disabled="true">
                                  </li>

                                  <li>
                                      <p>* 预售价（元）</p>
                                      <input type="text" value="<?php echo $g_info['pre_sale_price']; ?>"
                                             name="sld_stock[<?php echo $g_info['gid']; ?>]" disabled="true">
                                  </li>
                              </ul>
                          </div>
                      <?php } }?>
