...
<div class="page">
    ...
    <div class="mb-special-layout">
        ...
        <div id="part_left">
            <form id="subject_save" method="post" action="<?php echo urlAdmin('sld_cwap_home', 'zdy_save',['sld_addons'=>'presale']);?>">
...
<script>
    ...
    $('.btn_mb_special_goods_search').live('click', function() {
        var url = '<?php echo urlAdmin('sld_cwap_home', 'goods_list_zdy',['sld_addons'=>'presale']);?>';
