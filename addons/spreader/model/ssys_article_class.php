...
class ssys_article_classModel{
	...
	public function getClassList($condition){
		...
		$param = array();
		$param['table'] = 'ssys_article_class';
		$param['where'] = $condition_str;
		$param['order']	= empty($condition['order'])?'ac_parent_id asc,ac_sort asc,acid asc':$condition['order'];
	...
	public function add($param){
		...
		if (is_array($param)){
			...
			$result = Db::insert('ssys_article_class',$tmp);
			return $result;
		}else {
			return false;
		}
	...
	public function update($param){
		...
		if (is_array($param)){
			...
			$where = " acid = '". $param['acid'] ."'";
			$result = Db::update('ssys_article_class',$tmp,$where);
			return $result;
		}else {
			return false;
		}
	...
	public function del($id){
		if (intval($id) > 0){
			$where = " acid = '". intval($id) ."'";
			$result = Db::delete('ssys_article_class',$where);
			return $result;
		}else {
			return false;
		}
	...
	public function getChildClass($parent_id){
		$all_class = $this->getClassList(array('order'=>'ac_parent_id asc,ac_sort asc,acid asc'));
