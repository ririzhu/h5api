...
class ssys_uploadModel{
	...
	public function add($param){
		...
		if (is_array($param)){
			$result = Db::insert('ssys_upload',$param);
			return $result;
		}else {
			return false;
		}
	...
	public function update($param){
		...
		if (is_array($param)){
			...
			$result = Db::update('ssys_upload',$tmp,$where);
			return $result;
		}else {
			return false;
		}
	...
	public function updatebywhere($param,$conditionarr){
		...
		if (is_array($param)){
			...
			$result = Db::update('ssys_upload',$tmp,$condition_str);
			return $result;
		}else {
			return false;
		}
	...
	public function del($id){
		if (intval($id) > 0){
			...
			$result = Db::delete('ssys_upload',$where);
			return $result;
		}else {
			return false;
		}
	...
	public function dropUploadById($id){
		...
		$result = Db::delete('ssys_upload',$condition_str);
		return $result;
	}
	/**
	 * 删除图片信息，根据where
