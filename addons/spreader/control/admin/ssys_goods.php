...
class ssys_goodsCtl extends SystemCtl
{
    ...
    public function goods_list()
    {
        ...
        $goods_list = $this->shop_api_get_goods_SKU($condition,'gid,goods_commonid,goods_name,vid,goods_price,goods_image,goods_jingle','','',$pageSize);

        $total_num = $this->shop_api_get_goods_SKU_count($condition);
    ...
    // 商户系统 对应方法
    public function shop_api_get_goods_SKU_count($condition)
    {
        $goods_model = Model('goods');
        $goods_count = $goods_model->getGoodsOnlineCount($condition);
