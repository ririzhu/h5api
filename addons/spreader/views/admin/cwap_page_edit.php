...
<div class="page">
  ...
  <div class="mb-special-layout">
    ...
    <div id="part_left">
        <form id="subject_save" method="post" action="<?php echo urlAdmin('cwap_topic', 'zdy_save',array('sld_addons'=>'spreader'));?>">
...
<script>
    ...
    $('.btn_mb_special_goods_search').live('click', function() {
        var url = '<?php echo urlAdmin('cwap_topic', 'goods_list_zdy');?>';
