  ...
  <form method="get">
    ...
    <tr>
      ...
      <td class="w100"><select name="tuan_state" class="w90">
        ...
        <option value="30" <?php if('30' === $_GET['tuan_state']) { echo 'selected';}?>>拼团成功</option>
        </select></td>
...
<table class="bbc_ms-table-style">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td><?php if($group['order_state']==20){echo '已付定金';}elseif($group['order_state']==30){echo '已付尾款';}elseif($group['order_state']==0){echo '拼团失败';}else{echo '未付定金';}?></td>
      <td>
              -
      </td>
    </tr>
