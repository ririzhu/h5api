...
<!--      <dl>
      ...
      <dl>
          <dt><i class="required">*</i><?php echo '阶梯团类别:';?></dt>
          <dd>
              <!--      分类是二级的代码 留着点
              ...
              <select id="class_id" name="class_id" class="w80" disabled="true">
                  <?php if(is_array($output['class_list'])) { ?>
                  <?php foreach($output['class_list'] as $tuan_class) { ?>
                  <option <?php echo $output['pin_info']['sld_type']==$tuan_class['id']?'selected':'';?> value="<?php echo $tuan_class['id'];?>"><?php echo $tuan_class['class_name'];?></option>
                  <?php } ?>
                  <?php } ?>
              </select>
              <span></span>
<!--              <p class="hint">--><?php //echo $lang['tuan_class_tip'];?><!--</p>-->
      ...
      <dl>
          ...
          <dd>
              否:<input type="radio" name="is_tui" value="0" <?php echo $output['pin_info']['is_tui']==0?'checked':''; ?> disabled="true">
              是: <input type="radio" name="is_tui" value="1" <?php echo $output['pin_info']['is_tui']==1?'checked':''; ?> disabled="true">
              <!--                    <input class=" text w60" name="sld_team_count" type="text" id="sld_team_count"-->
              <!--                           value="--><?php //echo $output['pin_info']['sld_team_count'] ? $output['pin_info']['sld_team_count'] : 3; ?><!--"-->
              <!--                           maxlength="30"/>-->
              <!--                    <span></span>-->
...
<!--                                      <th>操作</th>-->
                                  ...
                                  <tr>
                                      ...
                                      <td><input type="text" readonly value="<?php echo $v['people_num']?>" name="ladder['+v.gid+'][number][]"></td>
                                      <td><input type="text" readonly value="<?php echo $v['pay_money']?>" name="ladder['+v.gid+'][money][]"></td>
<!--                                      <td>-->
