$(function () {
    ...
    function getPayMode() {
        ...
        $.ajax({
            type: 'get',
            url: ApiUrl + '/index.php?app=buy_ladder&mod=payment&sld_addons=pin_ladder',
            data: {
                key: key,
                order_sn: order_sn,
    ...
    $('.go_pay').on('click', function () {
        ...
        function pay() {
            $.ajax({
                type: 'post',
                url: ApiUrl + '/index.php?app=buy_ladder&mod=topay&sld_addons=pin_ladder',
                data: {
                    key: key,
                    order_sn: order_sn,
                    payment: payment
                ...
                success: function (res) {
                    ...
                    if (res.status == 200) {
                        ...
                        window.location.href = WapSiteUrl+'/my_pin.html';
