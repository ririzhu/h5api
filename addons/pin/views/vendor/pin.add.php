  ...
  <form id="add_form" action="<?php echo urlAddons('save');?>" method="post" enctype="multipart/form-data">
      ...
      <dl style="display: none;">
          ...
          <dd>
              ...
              <input type="radio" name="sld_status" checked="checked" <?php if($output['pin_info']['sld_status']===1 || !isset($output['pin_info'])){?>checked="checked"<?php }?> value="1" id="sld_status1" class="vm mr5" />
              <label for="sld_status0">禁用</label>
              <input type="radio" name="sld_status" <?php if(!$output['pin_info']['sld_status']===1){?>checked="checked"<?php }?> value="0" id="sld_status0" class="vm mr5" />
              <span></span>
      ...
      <dl>
          ...
          <dd>
              <input id="start_time" name="start_time" value="<?php echo $output['pin_info']['start_time_text'];?>" type="text" class="text w130" /><em class="add-on"><i class="iconfontfa fa-calendar"></i></em>  至
              <input id="end_time" name="end_time" value="<?php echo $output['pin_info']['end_time_text'];?>" type="text" class="text w130"/><em class="add-on"><i class="iconfontfa fa-calendar"></i></em>
      ...
      <dl>
          ...
          <dd>
              <input class=" text w60" name="sld_return_leader" type="text" id="sld_return_leader" value="<?php echo $output['pin_info']['sld_return_leader']?$output['pin_info']['sld_return_leader']:0;?>" maxlength="10"  /> 元
              <span></span>
      ...
      <dl>
          ...
          <dd>
              <input class=" text w60" name="sld_max_buy" type="text" id="sld_max_buy" value="<?php echo $output['pin_info']['sld_max_buy']!=''?$output['pin_info']['sld_max_buy']:1;?>" maxlength="30"  /> 件
              <span></span>
      ...
      <dl>
          ...
          <dd>
              <input class=" text w60" name="sld_team_count" type="text" id="sld_team_count" value="<?php echo $output['pin_info']['sld_team_count']?$output['pin_info']['sld_team_count']:3;?>" maxlength="30"  /> 人
              <span></span>
              <p class="hint">建议3人以上</p>
          </dd>
      </dl>
      <dl>
          ...
          <dd>
              <input class=" text w60" name="sld_success_time" type="text" id="sld_success_time" value="<?php echo $output['pin_info']['sld_success_time']?$output['pin_info']['sld_success_time']:24;?>" maxlength="30"  /> 小时
              <span></span>
                  ...
                  <?php if(is_array($output['pin_info']['goods_list'])) { ?>
                      <?php foreach($output['pin_info']['goods_list'] as $g_info) { ?>
                          <ul>
                              ...
                              <li>
                                  <p>* 拼团价格（元）</p>
                                  <input type="text" value="<?php echo $g_info['sld_pin_price'];?>" name="sld_pin_price[]">
                              </li>
                              <p>* 拼团库存（件）</p>
                              <input type="text" value="<?php echo $g_info['sld_stock'];?>" name="sld_stock[]">
