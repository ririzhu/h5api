$(function (){
	...
	tmpl2+='<div style=""><div id="nav-tab"><div class="clearfix tab-line nav"><div class="tab-line-item" style="width:25%;" >';
	if(wap_now == "sld_home"){
		tmpl2+='<a class="sle" href="index.html"><span class="wap_footer_img"><i class="icoTaba"></i></span><br>首页</a>';
	}else{
		tmpl2+='<a href="index.html"><span class="wap_footer_img"><i class="icoTabA"></i></span><br>首页</a>';
	}
	tmpl2+='</div>';
			...
			//}
    // tmpl2 += '</div>'
    tmpl2 += '<div class="tab-line-item" style="width:25%;" >';
    if (wap_now == "sld_faxian") {
        tmpl2 += '<a class="sle" href="cart.html"><span class="wap_footer_img"><i class="icoTabb"></i></span><br><span class="mid-title"><span>购物车</a>';
    } else {
        tmpl2 += '<a href="cart.html"><span class="wap_footer_img"><i class="icoTabB"></i><i class="tip"></i></span><br><span class="mid-title">购物车</span></a>';
    }
    tmpl2 += '</div>';
	tmpl2+='<div class="tab-line-item" style="width:25%;position: relative;padding-top: 0.15rem" >';
	if(wap_now == "sld_cart"){
		tmpl2+='<a class="sle" href="cwap_my_order.html"><span class="wap_footer_img"><img src="images/dindan2.png" alt="222"></span><br>订单</a>';
	}else{
		tmpl2+='<a href="cwap_my_order.html"><span class="wap_footer_img"><img src="images/dindan.png" alt=""></span><br>订单</a>';
	}
	tmpl2+='</div>';
	tmpl2+='<div class="tab-line-item" style="width:25%;" >';
	if(wap_now == "sld_mine"){
		tmpl2+='<a class="sle" href="cwap_user.html"><span class="wap_footer_img"><i class="icoTabD"></i></span><br>我的</a>';
	}else{
		tmpl2+='<a href="cwap_user.html"><span class="wap_footer_img"><i class="icoTabd"></i></span><br>我的</a>';
	}
	tmpl2+='</div>';
	...
	if(key){
        $.ajax({
            type: 'get',
            url:  ApiUrl+'/index.php?app=cart&mod=getCartLookStatus&sld_addons=ldj',
            data:{
				key: key
            },
			dataType: 'json',
			success: function (res) {
				if(res==1){
					$('#bottom .wap_footer_img .tip').show();
				}
            }
        })
	}
