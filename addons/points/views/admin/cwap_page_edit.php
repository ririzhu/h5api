...
<div class="page">
  ...
  <div class="mb-special-layout">
    ...
    <div id="part_left">
        <form id="subject_save" method="post" action="<?php echo urlAdmin('cwap_topic', 'zdy_save',array('sld_addons'=>'points'));?>">
                ...
                <?php if($value['type']=='tuijianshangpin'){?>
                        <div data_tjsp_index="<?php echo $key;?>" class="special-item tuijianshangpin_part default_tuijianshangpin_part">
                            ...
                            <?php foreach ($value[data][goods_info] as $k => $v){?>
                                   <li>
                                        <input class="add_gid" name="item_data[<?php echo $key;?>][data][gid][]" type="hidden" value="<?php echo $v['pgid'];?>">
                                        <a href="javascript:;">
                                            <div class="goods-image"><img src="<?php echo $v['pgoods_image'];?>"></div>
                                            <div class="goods-info">
                                                <p class="goods-title" ><?php echo $v['pgoods_name'];?></p>
                                                <p class="goods-price" >积分<?php echo $v['pgoods_points'];?></p>
                                            </div>
                                        </a>
                                    </li>
                        <?php }?>
                                    ...
                                    <div class="swiper-goods-container">
                                        <div  class="swiper-wrapper">
                                            ...
                                            <div  class="swiper-slide">
                                                <input class="add_dapei_gid" name="item_data[<?php echo $key;?>][data][gid][]" type="hidden" value="<?php echo $dapei_v['pgid'];?>">
                                                <a>
                                                    <div class="goods-image"><img  src="<?php echo $dapei_v['pgoods_image'];?>"></div>
                                                    <div class="goods-info"><p class="goods-title">
                                                            <?php echo $dapei_v['pgoods_name'];?>11</p>
                                                        <p class="goods-price">积分<?php echo $dapei_v['pgoods_points'];?></p></div>
                                                </a>
                                            </div>
                                            <?php }?>
                                            <?php }?>
...
<script>
    ...
    $('.btn_mb_special_goods_search').live('click', function() {
        var url = '<?php echo urlAdmin('cwap_topic', 'goods_list_zdy',array('sld_addons'=>'points'));?>';
        ...
        console.log(keyword,goods_activity_type);
...
//        }
    ...
    $('#btn_dapei_goods_search').live('click', function() {
        var url = '<?php echo urlAdmin('cwap_topic', 'goods_list_zdy',['sld_addons'=>'points']);?>';
        var keyword = $(this).parents('.search-goods').find('.txt_goods_name').val();
        var goods_activity_type = $(this).parents('.search-goods').find('.goods_activity_type option:selected').val();
//        if(keyword || goods_activity_type) {
            $(this).parents('.search-goods').find(".mb_special_goods_list").load(url, {keyword: keyword,goods_activity_type: goods_activity_type});
    ...
    <li>
        ...
        <a href="javascript:;">
            ...
            <div class="goods-info">
                ...
                <p class="goods-price" >积分<%=goods_info[i].goods_price%></p>
            </div>
        </a>
    </li>
    <% }%>
                        ...
                        <div  class="swiper-wrapper">
                            <div  class="swiper-slide">
                                <a>
                                    ...
                                    <div class="goods-info"><p class="goods-title">
                                            第1个商品名称</p>
                                        <p class="goods-price">积分9.00</p></div>
                                </a>
                            </div>
                            <div  class="swiper-slide">
                                <a>
                                    ...
                                    <div class="goods-info"><p class="goods-title">
                                            第2个商品名称</p>
                                        <p class="goods-price">积分18.00</p></div>
                                </a>
                            </div>
                            <div class="swiper-slide ">
                                <a>
    ...
    <div class="swiper-slide">
        ...
        <a>
            ...
            <div class="goods-info"><p class="goods-title ng-binding"><%=goods_info[i].goods_name%></p>
                <p class="goods-price">积分<%=goods_info[i].goods_price%></p></div>
        </a>
    </div>
    <% }%>
