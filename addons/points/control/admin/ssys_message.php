...
class ssys_messageCtl extends SystemCtl
{
    private $links = array(
    ...
    public function getSldBaseInfo(){
        ...
        if($_POST['type'] == 'save'){
            //保存编辑信息
            $update_array = array();
            $update_array['ssys_gzh_appid'] 	= $_POST['ssys_gzh_appid'];
            $update_array['ssys_gzh_secret'] 	= $_POST['ssys_gzh_secret'];
            ...
            $data = array();
            $data['ssys_gzh_appid'] = $list_setting['ssys_gzh_appid'];
            $data['ssys_gzh_secret'] = $list_setting['ssys_gzh_secret'];
    ...
    public function smsInfo(){
        ...
        if ($_POST[type] == 'save'){
            $update_array = array();
            $update_array['ssys_mobile_tplid'] 		= $_POST['ssys_mobile_tplid'];//云片短信模板id
            $update_array['ssys_mobile_memo']   = $_POST['ssys_mobile_memo'];//云片短信模板内容
            $update_array['ssys_mobile_signature'] 	= $_POST['ssys_mobile_signature'];//云片短信模板内容
            $result = $model_setting->updateSetting($update_array);
            if ($result === true){
            ...
            $list_setting = $model_setting->getListSetting();
            $data = array();
            $data['ssys_mobile_tplid'] = $list_setting['ssys_mobile_tplid'];
            $data['ssys_mobile_memo'] = $list_setting['ssys_mobile_memo'];
            $data['ssys_mobile_signature'] = $list_setting['ssys_mobile_signature'];
