...
//                        $goods_info = $model_goods -> getGoodsOnlineInfoByID($v,'gid,goods_name,goods_promotion_price,goods_price,goods_image');
                        $goods_info = $model_goods ->cwap_GetPointsGoodsList(['pgid'=>$v],'pgid,pgoods_name,pgoods_price,pgoods_points,pgoods_image')[0];
                        if(!empty($goods_info)){
                            $goods_info['pgoods_image'] = pointprodThumb($goods_info['pgoods_image']);
