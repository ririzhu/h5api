...
class ssys_cashCtl extends SystemCtl{
    ...
    public function changeCashState(){
        ...
        try {
            ...
            $this->add_shop_member_predeposit_amount_by_api($member_info['shop_member_id'],$info['pdc_amount']);
            $ssys_yj->commit();
            $this->log($log_msg,1);
    ...
    // 向 推手关联的 商城用户 增加可用余额
    public function add_shop_member_predeposit_amount_by_api($member_id,$amount){
